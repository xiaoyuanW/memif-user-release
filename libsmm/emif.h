...
/* Base address */
#define EMIF1_BASE				0x21010000  // evmk2h
#define EMIF2_BASE				0x21020000

/* xzl: functions */
extern int emif_perfcnt_init(void);
extern void emif_perfcnt_start(void);
extern void emif_perfcnt_end(void);
